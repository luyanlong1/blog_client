...
<div>
    <div style="width:100%;text-align: left;background:#6e8cd7;color: #fff;padding: 10px 20px;">
        <h3 style="font-size: 15px;font-weight: 600;line-height: 20px;margin-top: .5rem;">草稿箱</h3>
    </div>
    <el-table :data="tableData.filter(data => !search || data.title.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
        ...
        <el-table-column  label="发布日期" prop="createTime" width="250px" align="center"  :formatter="formatterDate"></el-table-column>
        ...
        <el-table-column  align="right">
            ...
            <template slot-scope="scope">
                ...
                <el-button icon="el-icon-share" size="mini" type="primary" @click="handlePublish(scope.$index, scope.row)" style="margin-right:10px">发布</el-button>
...
export default {
    ...
    methods:{
        ...
        getBlogs: function (pageNo) {
            ...
            var this_ = this;
            var param = {"pageNo":pageNo,"pageSize":this_.pageSize,"state":"0"};
